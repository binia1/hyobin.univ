// ================= 기존 영문 링크 보존 및 새 한국어 링크 매핑 로직 =================
const OLD_URLS = {
    "총장인사말": "hbnu_about.html#president", "대학이념": "hbnu_about.html#identity", "대학연혁": "hbnu_history.html", "캠퍼스안내": "hbnu_campus.html", "오시는길": "hbnu_location.html",
    "수시모집": "hbnu_admission_guide.html?type=susi", "정시모집": "hbnu_admission_guide.html?type=jungsi", "편입학": "hbnu_transfer.html", "대학원입학": "hbnu_grad.html", "외국인전형": "hbnu_global.html",
    "대학(단과대)": "hbnu_colleges.html", "일반대학원": "hbnu_grad.html", "학사일정안내": "hbnu_calendar.html", "중앙도서관": "hbnu_library.html", "연구소 현황": "hbnu_research.html",
    "장학제도": "hbnu_scholarship.html", "학생복지": "hbnu_welfare.html", "동아리": "hbnu_clubs.html", "효빈뉴스": "hbnu_news_list.html", "병무행정": "hbnu_military.html",
    "공지사항": "hbnu_community.html", "자유게시판": "hbnu_board_free.html", "벼룩시장": "hbnu_market.html", "분실물센터": "hbnu_market.html?tab=lost", "정보공개": "hbnu_info_disclosure.html",
    "개인정보처리방침": "hbnu_privacy.html", "이메일무단수집거부": "hbnu_email_refusal.html", "사이트맵": "hbnu_sitemap.html", "전화번호안내": "hbnu_directory.html"
};

function getMenuUrl(label) {
    return OLD_URLS[label] || (label.replace(/\//g, '_').replace(/ /g, '') + ".html");
}
...
const MEGA_MENU = [
    ...
    { title: "대학/대학원", url: "hbnu_academics.html", groups: [
    ...
    { title: "대학생활", url: "hbnu_life.html", groups: [
        { name: "캠퍼스생활", items: ["식단안내", "차량등록", "통학버스", "기숙형대학", "병무행정", "직장예비군"] },
        { name: "캠퍼스시설", items: ["중앙도서관", "생활관", "보건진료소", "인권센터", "생활협동조합", "JBNU ON AI"] },
        { name: "신입생안내", items: ["신입생 안내", "학생증발급", "캠퍼스타운"] }
    ]},
    ...
    { title: "SNS", url: "sns.html", groups: [
        { name: "공식 미디어", items: ["인스타그램", "유튜브", "페이스북", "네이버블로그", "엑스"] }
    ]},
    { title: "HBNU anis", url: "효빈위키.html", groups: [
...
const TEXT_CONTENT = {
    KOR: {
        universityName: "효빈대학교", universitySub: "Hyobin National University", slogan: "불굴(不屈)의 역사, 혁신(革新)으로 미래를 열다",
        ...
        <div class="bg-gray-100 border-b text-xs py-2 px-4 hidden md:block">
            <div class="max-w-7xl mx-auto flex justify-between items-center text-gray-600">
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <button onclick="navigateTo('hbnu_webmail.html')" class="hover:text-[#3344aa]">${T.utility.mail}</button>
                    <span class="text-gray-300">|</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 border-b border-gray-700 pb-8">
                ...
                <div class="col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="text-xs text-gray-400 space-y-2">
                            <li><button onclick="navigateTo('hbnu_privacy.html')" class="hover:text-white">개인정보처리방침</button></li>
                            <li><button onclick="navigateTo('hbnu_email_refusal.html')" class="hover:text-white">이메일무단수집거부</button></li>
